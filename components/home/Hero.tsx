            ...
            <div className="container relative mx-auto h-full flex items-center z-60">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-4 text-xl text-gray-200">
                        Discover the latest trends in fashion. Shop our
                        exclusive summer collection with up to 50% off.
                    </p>

                    <div className="mt-4 flex gap-4">
                        <Link
                            href="/"
                            className="px-4 py-2 w-fit flex items-center gap-2 transition-all text-black text-sm bg-white rounded-lg group"
                        >
                            Shop Now
                            <ArrowRight className="w-5 group-hover:translate-x-1 transition-all" />
                        </Link>

                        <Link
                            href="/"
                            className="px-4 py-2 w-fit flex items-center gap-2
